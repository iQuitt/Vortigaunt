...
static uint32_t sosemanuk_mul_a[] = { // Sosemanuk LFSR  a1* https://cr.yp.to/streamciphers/sosemanuk/desc.pdf
...
static uint32_t sosemanuk_div_a[] = { // Sosemanuk LFSR a^-1 division table  https://hizliresim.com/4x4n77l
